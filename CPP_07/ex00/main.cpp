...
int main(void) {
	{
		std::cout << GREY << "====== MAIN FROM SUBJECT ======" << NC <<
		          std::endl;
		int a = 2;
		int b = 3;
	...
	}
	{
		...
		std::cout << ORANGE << "====== STRING TEMPLATES TEST ======" << NC <<
		          std::endl;
		std::cout << "a = " << a << ", b = " << b <<
		          std::endl;

		tic_tac(100000, 1, ORANGE);
		std::cout << ORANGE << "=== SWAP ===" << NC <<
		          std::endl;
	...
	}
	{
		...
		std::cout << GREEN << "====== INT TEMPLATES TEST ======" << NC <<
		          std::endl;
		std::cout << "a = " << a << ", b = " << b <<
		          std::endl;

		tic_tac(100000, 1, GREEN);
		std::cout << GREEN << "=== SWAP ===" << NC <<
		          std::endl;
		std::cout << "Before swap(a, b):" <<
		          std::endl;
		std::cout << "a = " << a << ", b = " << b <<
	...
	}
	{
		...
		std::cout << CYAN << "====== FLOAT TEMPLATES TEST ======" << NC <<
		          std::endl;
		std::cout << "a = " << a << ", b = " << b <<
		          std::endl;

		tic_tac(100000, 1, CYAN);
		std::cout << CYAN << "=== SWAP ===" << NC <<
		          std::endl;
		std::cout << "Before swap(a, b):" <<
		          std::endl;
		std::cout << "a = " << a << ", b = " << b <<
	...
	}
	{
		...
		std::cout << RED << "====== DOUBLE TEMPLATES TEST ======" << NC <<
		          std::endl;
		std::cout << "a = " << a << ", b = " << b <<
		          std::endl;

		tic_tac(100000, 1, RED);
		std::cout << RED << "=== SWAP ===" << NC <<
		          std::endl;
		std::cout << "Before swap(a, b):" <<
		          std::endl;
		std::cout << "a = " << a << ", b = " << b <<
	...
	}
	{
		...
		std::cout << PURPLE << "====== CHAR TEMPLATES TEST ======" << NC <<
		          std::endl;
		std::cout << "a = " << a << ", b = " << b <<
		          std::endl;

		tic_tac(100000, 1, PURPLE);
		std::cout << PURPLE << "=== SWAP ===" << NC <<
		          std::endl;
		std::cout << "Before swap(a, b):" <<
		          std::endl;
		std::cout << "a = " << a << ", b = " << b <<
